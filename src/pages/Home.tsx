...
export default function Home() {
  return (
    <div className="relative h-auto w-screen pt-4">
      <div className="absolute bg-gradient-to-br from-slate-800/[0.3] to-slate-500/[0.3] skew-y-12 w-[50%] h-[60%] left-0" />
      <div className="absolute bg-gradient-to-br from-orange-400/[0.3] to-orange-600/[0.3] -skew-y-12 w-[50%] h-[60%] right-0" />
      <div className="relative flex justify-center items-center h-[8%] w-full my-10">
        <HomeTextBanner />
      </div>
