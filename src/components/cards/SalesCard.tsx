...
const SalesCard = () => {
  return (
    ...
    >
      <div className="flex h-full w-full items-center justify-center font-main text-[1.6rem] font-black tracking-[0.2rem] text-white duration-300 group-hover:tracking-[0.4rem] sm:text-[2rem]">
        SPECIAL OFFERS
      </div>
