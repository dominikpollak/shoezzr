...
const HomepageCard: React.FC<HomepageCardProps> = ({
  ...
  return (
    <Link
      to={link}
      className="group homepage-card ring-4 ring-white hover:ring-offset-4 ring-offset-black relative w-[25%] h-full rounded-2xl shadow-md duration-300 overflow-hidden"
    >
